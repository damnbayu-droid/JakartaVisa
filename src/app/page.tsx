    ...
    <div className="min-h-screen flex flex-col bg-slate-50 w-full overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 px-4 py-4 transition-all duration-300 ${scrolled ? 'bg-white/98 shadow-lg' : 'bg-white'
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <a href="https://voajakarta.com" className="text-2xl md:text-4xl font-black tracking-tight text-slate-800 hover:text-slate-700 transition-colors">
            VOAJAKARTA
          </a>
          <a
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-purple-300 via-purple-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-base md:text-xl lg:text-2xl mb-8 md:mb-10 leading-relaxed text-slate-700">
              Fast, reliable, and professional visa services for your Jakarta adventure. We serve 97 countries with expert support and dedicated customer service available 24/7.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-slate-800 text-white px-6 md:px-12 py-4 md:py-6 rounded-full font-bold text-base md:text-xl hover:bg-amber-400 hover:text-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg inline-flex items-center gap-2"
            >
      ...
      <section className="py-16 md:py-20 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4 md:mb-6 text-slate-800">Why Choose VOA JAKARTA?</h2>
      ...
      <section className="py-16 md:py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-6 text-slate-800">Essential Jakarta Visa Information</h2>
