...
z-ai image -p "Vibrant illustration of community connection" -o "./og-image.webp" -s 1024x1024

# Website favicon/logo
z-ai image -p "Simple geometric logo with blue gradient, minimal design" -o "./logo.webp" -s 1024x1024

# Background pattern
z-ai image -p "Subtle geometric pattern, pastel colors, website background" -o "./oh-image.webp" -s 1440x720
```
